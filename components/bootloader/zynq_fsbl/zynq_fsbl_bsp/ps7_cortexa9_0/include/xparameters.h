...
/* Definitions for peripheral AXI_GPIO_PRODUCTION_CONTROLLER_OUT */
#define XPAR_AXI_GPIO_PRODUCTION_CONTROLLER_OUT_BASEADDR 0x41200000
#define XPAR_AXI_GPIO_PRODUCTION_CONTROLLER_OUT_HIGHADDR 0x4120FFFF
#define XPAR_AXI_GPIO_PRODUCTION_CONTROLLER_OUT_DEVICE_ID 0
#define XPAR_AXI_GPIO_PRODUCTION_CONTROLLER_OUT_INTERRUPT_PRESENT 0
#define XPAR_AXI_GPIO_PRODUCTION_CONTROLLER_OUT_IS_DUAL 1


/******************************************************************/

/* Canonical definitions for peripheral AXI_GPIO_PRODUCTION_CONTROLLER_OUT */
#define XPAR_GPIO_0_BASEADDR 0x41200000
#define XPAR_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_GPIO_PRODUCTION_CONTROLLER_OUT_DEVICE_ID
...
/* Definitions for peripheral AXI_FIFO_PRODUCTION */
#define XPAR_AXI_FIFO_PRODUCTION_DEVICE_ID 0
#define XPAR_AXI_FIFO_PRODUCTION_BASEADDR 0x43C00000
#define XPAR_AXI_FIFO_PRODUCTION_HIGHADDR 0x43C0FFFF
#define XPAR_AXI_FIFO_PRODUCTION_AXI4_BASEADDR 0x80001000
#define XPAR_AXI_FIFO_PRODUCTION_AXI4_HIGHADDR 0x80002FFF
#define XPAR_AXI_FIFO_PRODUCTION_DATA_INTERFACE_TYPE 0


/******************************************************************/

/* Canonical definitions for peripheral AXI_FIFO_PRODUCTION */
#define XPAR_AXI_FIFO_0_DEVICE_ID XPAR_AXI_FIFO_PRODUCTION_DEVICE_ID
