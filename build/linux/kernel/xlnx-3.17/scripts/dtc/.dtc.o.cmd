cmd_scripts/dtc/dtc.o := gcc -Wp,-MD,scripts/dtc/.dtc.o.d -Iscripts/dtc -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer  -I/opt/pkg/petalinux-v2014.4-final/components/linux-kernel/xlnx-3.17/scripts/dtc -Iscripts/dtc  -I/opt/pkg/petalinux-v2014.4-final/components/linux-kernel/xlnx-3.17/scripts/dtc/libfdt -Iscripts/dtc/libfdt -c -o scripts/dtc/dtc.o /opt/pkg/petalinux-v2014.4-final/components/linux-kernel/xlnx-3.17/scripts/dtc/dtc.c

source_scripts/dtc/dtc.o := /opt/pkg/petalinux-v2014.4-final/components/linux-kernel/xlnx-3.17/scripts/dtc/dtc.c
